...
public class Reservation {
    ...
    private org.eternity.movie.assignment2.Screening Screening;
    private Money fee;
    private LocalDateTime whenReservation;
    private member members;

    public Reservation(Customer customer, org.eternity.movie.assignment2.Screening Screening, Money fee, member members) {
