...
public class AttackChangeAllUnitWhenAnyUnitDie extends AttackTurn {
    /**
     ...
     */
    public AttackChangeAllUnitWhenAnyUnitDie(Player attacker, Player defender) {
